...
**Current state:** the repo holds only `CLAUDE.md` and `ROADMAP.md`. Nothing in the "Project Structure" section below has been created yet — it is the target layout. Phase 0 (scaffolding) per `ROADMAP.md` is the entry point.
